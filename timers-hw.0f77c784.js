...
const interval = setInterval(()=>{
    ...
    if (time === 30) alert("\u0417\u0430\u043B\u0438\u0448\u0438\u043B\u043E\u0441\u044C \u043F\u043E\u043B\u043E\u0432\u0438\u043D\u0430 \u0447\u0430\u0441\u0443");
    else if (time === 0) {
...
function startTimer() {
    ...
    id = setInterval(()=>{
        total -= 10;
        if (total <= 10000) boxRef.classList.add("animation");
        if (total <= 0) {
            total = 0;
            clearInterval(id);
            id = null;
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequireb977", {})

//# sourceMappingURL=timers-hw.0f77c784.js.map
